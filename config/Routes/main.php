...
$router->map(method: 'GET', route: '/post/edit/', target: 'PostController#editPostForm', name: 'editPostForm');
...
$router->map(method: 'POST', route: '/post/update/', target: 'PostController#editPostAction', name: 'updatePostAction');
//Individual Posts
